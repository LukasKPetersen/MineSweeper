...
public class Controller {
				...
				if (y > headerHeight) {
					...
					if (x > borderThickness && x < length - borderThickness && 
							...
							if (event.getButton().toString() == "PRIMARY") {
								...
								//if leftclick is released play mousereleasesound, determine wether its falseclick
	...
	//checks if the position of mousepressed is the same as position of mouse released.	
